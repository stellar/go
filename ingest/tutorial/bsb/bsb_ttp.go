...
func main() {
	...
	datastoreConfig := datastore.DataStoreConfig{
		...
		Params: map[string]string{
			"destination_bucket_path": "sdf-ledger-close-meta/ledgers/pubnet", // Replace with actual GCS bucket path
		},
	...
	for ledgerSeq := ledgerRange.From(); ledgerSeq <= ledgerRange.To(); ledgerSeq++ {
		...
		ttpVerificationRes := token_transfer.VerifyEvents(ledger, network.PublicNetworkPassphrase)
