...
func makeTrade(asset xdr.Asset, deposit xdr.Int64, pool xdr.LiquidityPoolEntry) (uint64, error) {
	...
	payoutXdr, ok := calculatePoolPayout(X, Y, deposit, details.Params.Fee)
	if !ok {
