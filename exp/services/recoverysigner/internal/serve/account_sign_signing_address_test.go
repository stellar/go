...
func TestAccountSign_signingAddressAuthenticatedButNotFound(t *testing.T) {
	...
	h := accountSignHandler{
		...
		SigningKeys: []*keypair.Full{
			keypair.MustParseFull("SBIB72S6JMTGJRC6LMKLC5XMHZ2IOHZSZH4SASTN47LECEEJ7QEB6EYK"),
			keypair.MustParseFull("SBJGZKZ7LU2FQNEFBUOBW4LHCA5BOZCABIJTR7BQIFWQ3P763ZW7MYDD"),
		},
