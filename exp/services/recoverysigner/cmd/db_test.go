...
func TestDBCommand_Migrate_upDownAll(t *testing.T) {
	...
	// Migrate Up
	{
		...
		wantMessages := []string{
			"Migrations to apply up: 20200309000000-initial-1.sql, 20200309000001-initial-2.sql, 20200311000000-create-accounts.sql, 20200311000001-create-identities.sql, 20200311000002-create-auth-methods.sql, 20200320000000-create-accounts-audit.sql, 20200320000001-create-identities-audit.sql, 20200320000002-create-auth-methods-audit.sql, 20200601000000-create-signing-keys.sql",
			"Successfully applied 9 migrations up.",
		}
	...
	// Migrate Down
	{
		...
		wantMessages := []string{
			"Migrations to apply down: 20200601000000-create-signing-keys.sql, 20200320000002-create-auth-methods-audit.sql, 20200320000001-create-identities-audit.sql, 20200320000000-create-accounts-audit.sql, 20200311000002-create-auth-methods.sql, 20200311000001-create-identities.sql, 20200311000000-create-accounts.sql, 20200309000001-initial-2.sql, 20200309000000-initial-1.sql",
			"Successfully applied 9 migrations down.",
		}
		assert.Equal(t, wantMessages, messages)
	}
}
