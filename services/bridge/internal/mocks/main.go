...
func (m *MockHorizon) SubmitTransaction(txeBase64 string) (response horizon.TransactionSuccess, err error) {
...
// SubmitTransaction is a mocking a method
func (ts *MockTransactionSubmitter) SubmitTransaction(paymentID *string, seed string, operation, memo interface{}) (response horizon.TransactionSuccess, err error) {
	a := ts.Called(paymentID, seed, operation, memo)
	return a.Get(0).(horizon.TransactionSuccess), a.Error(1)
}

// SignAndSubmitRawTransaction is a mocking a method
func (ts *MockTransactionSubmitter) SignAndSubmitRawTransaction(paymentID *string, seed string, tx *xdr.Transaction) (response horizon.TransactionSuccess, err error) {
