...
Full documentation on Horizon's Orderbook endpoint can be found [here](https://developers.stellar.org/docs/data/horizon/api-reference/aggregations/order-books).
