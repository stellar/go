...
1. Add your migration to `services/horizon/internal/db2/schema/migrations/` using the same name nomenclature as other migrations.
   * We use https://github.com/rubenv/sql-migrate to manage migrations, sql-migrate require https://github.com/jteeuwen/go-bindata to generate the migrations meta data library. Install it with `go get -u github.com/jteeuwen/go-bindata/...`
