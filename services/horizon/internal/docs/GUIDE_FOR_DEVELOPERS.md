...
export STELLAR_CORE_VERSION="21.3.1-2006.4ede19620.focal"
```
...
```bash
PROTOCOL_VERSION=21 CORE_IMAGE=stellar/stellar-core:21 STELLAR_CORE_VERSION=21.3.1-2006.4ede19620.focal ./start.sh [standalone|pubnet]
```
