...
export STELLAR_CORE_VERSION="21.3.0-2004.55ec34840.focal"
```
...
```bash
PROTOCOL_VERSION=21 CORE_IMAGE=stellar/stellar-core:21 STELLAR_CORE_VERSION=21.3.0-2004.55ec34840.focal ./start.sh [standalone|pubnet]
```
