...
func (s *TradeProcessorTestSuiteLedger) SetupTest() {
	...
	for i, trade := range s.allTrades {
		...
		if i%2 == 0 {
			s.assetToID[assetToKey(trade.AssetSold())] = history.Asset{ID: int64(10000 + i)}
			s.assetToID[assetToKey(trade.AssetBought())] = history.Asset{ID: int64(100 + i)}
		} else {
			s.assetToID[assetToKey(trade.AssetSold())] = history.Asset{ID: int64(100 + i)}
			s.assetToID[assetToKey(trade.AssetBought())] = history.Asset{ID: int64(10000 + i)}
		}
	...
	inserts := []history.InsertTrade{
		{
			...
			BaseAssetID:        s.assetToID[assetToKey(s.strictReceiveTrade.AssetBought())].ID,
			...
			CounterAssetID:     s.assetToID[assetToKey(s.strictReceiveTrade.AssetSold())].ID,
		...
		},
		{
			...
			CounterAssetID:     s.assetToID[assetToKey(s.strictSendTrade.AssetBought())].ID,
			...
			BaseAssetID:        s.assetToID[assetToKey(s.strictSendTrade.AssetSold())].ID,
			BaseIsSeller:       true,
			BaseIsExact:        null.BoolFrom(false),
		...
		},
		{
			...
			BaseAccountID:      null.IntFrom(s.unmuxedAccountToID[s.unmuxedOpSourceAccount.Address()]),
			BaseAssetID:        s.assetToID[assetToKey(s.buyOfferTrade.AssetBought())].ID,
			...
			CounterAssetID:     s.assetToID[assetToKey(s.buyOfferTrade.AssetSold())].ID,
			BaseIsSeller:       false,
		...
		},
		{
			...
			CounterAssetID:     s.assetToID[assetToKey(s.sellOfferTrade.AssetBought())].ID,
			CounterAccountID:   null.IntFrom(s.unmuxedAccountToID[s.unmuxedOpSourceAccount.Address()]),
			...
			BaseAssetID:        s.assetToID[assetToKey(s.sellOfferTrade.AssetSold())].ID,
			BaseIsSeller:       true,
		...
		},
		{
			...
			BaseAssetID:        s.assetToID[assetToKey(s.passiveSellOfferTrade.AssetBought())].ID,
			...
			CounterAssetID:     s.assetToID[assetToKey(s.passiveSellOfferTrade.AssetSold())].ID,
			BaseIsSeller:       false,
...

		{
			...
			CounterAssetID:   s.assetToID[assetToKey(s.otherPassiveSellOfferTrade.AssetBought())].ID,
			CounterAccountID: null.IntFrom(s.unmuxedAccountToID[s.unmuxedOpSourceAccount.Address()]),
			...
			BaseAssetID:      s.assetToID[assetToKey(s.otherPassiveSellOfferTrade.AssetSold())].ID,
			BaseIsSeller:     true,
		...
		},
		{
			...
			BaseAssetID:            s.assetToID[assetToKey(s.strictReceiveTradeLP.AssetBought())].ID,
			BaseAccountID:          null.IntFrom(s.unmuxedAccountToID[s.unmuxedOpSourceAccount.Address()]),
			...
			CounterAssetID:         s.assetToID[assetToKey(s.strictReceiveTradeLP.AssetSold())].ID,
			BaseIsSeller:           false,
			BaseIsExact:            null.BoolFrom(false),
		...
		},
		{
			...
			CounterAssetID:      s.assetToID[assetToKey(s.strictSendTradeLP.AssetBought())].ID,
			CounterAccountID:    null.IntFrom(s.unmuxedAccountToID[s.unmuxedOpSourceAccount.Address()]),
			...
			BaseAssetID:         s.assetToID[assetToKey(s.strictSendTradeLP.AssetSold())].ID,
			BaseIsSeller:        true,
			BaseIsExact:         null.BoolFrom(false),
			LiquidityPoolFee:    null.IntFrom(int64(xdr.LiquidityPoolFeeV18)),
