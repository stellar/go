...
func (e *effectsWrapper) addClaimableBalanceEntryCreatedEffects(source *xdr.MuxedAccount, cb *xdr.ClaimableBalanceEntry) error {
	...
	// `create_claimable_balance` but also by `liquidity_pool_withdraw` which
	// also removes LP.
	...
	// changes all `rel_before` predicated to `abs_before` so effects generated
	// by Horizon 2.8.3 and 2.9.0 are different.
