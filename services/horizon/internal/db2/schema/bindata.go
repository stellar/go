...
func latestSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "latest.sql", size: 22500, mode: os.FileMode(420), modTime: time.Unix(1563392795, 0)}
...
func migrations18_account_for_signersSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "migrations/18_account_for_signers.sql", size: 481, mode: os.FileMode(420), modTime: time.Unix(1563391333, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
