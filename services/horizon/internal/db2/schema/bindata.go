...
func latestSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "latest.sql", size: 21288, mode: os.FileMode(420), modTime: time.Unix(1550753674, 0)}
...
func migrations16_ingest_failed_transactionsSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "migrations/16_ingest_failed_transactions.sql", size: 319, mode: os.FileMode(420), modTime: time.Unix(1550753648, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
