...
func migrations13_trade_offer_idsSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "migrations/13_trade_offer_ids.sql", size: 484, mode: os.FileMode(0644), modTime: time.Unix(1567081172, 0)}
...
func migrations20_account_for_signer_indexSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "migrations/20_account_for_signer_index.sql", size: 140, mode: os.FileMode(0644), modTime: time.Unix(1567449970, 0)}
