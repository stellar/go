...
func TestAssetsStatsQExec(t *testing.T) {
	item0 := AssetStatsR{
		SortKey:     "BTC_GC23QF2HUE52AMXUFUH3AYJAXXGXXV2VHXYYR6EYXETPKDXZSAW67XO4",
	...
	item1 := AssetStatsR{
		SortKey:     "SCOT_GCXKG6RN4ONIEPCMNFB732A436Z5PNDSRLGWK7GBLCMQLIFO4S7EYWVU",
		Type:        "credit_alphanum4",
		Code:        "SCOT",
	...
	item2 := AssetStatsR{
		SortKey:     "USD_GC23QF2HUE52AMXUFUH3AYJAXXGXXV2VHXYYR6EYXETPKDXZSAW67XO4",
		Type:        "credit_alphanum4",
		Code:        "USD",
		Issuer:      "GC23QF2HUE52AMXUFUH3AYJAXXGXXV2VHXYYR6EYXETPKDXZSAW67XO4",
