...
* Improve performance of `OffersProcessor`. This should speed up ingestion of latest Stellar Public Network activity by up to 30%. ([3917](https://github.com/stellar/go/pull/3917)) 
