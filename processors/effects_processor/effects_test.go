...
import (
	...
	operations "github.com/stellar/go/processors/operation_processor"
...
func BuildLedgerTransaction(t *testing.T, tx utils.TestTransaction) ingest.LedgerTransaction {
	transaction := ingest.LedgerTransaction{
		Index:      tx.Index,
		Envelope:   xdr.TransactionEnvelope{},
		Result:     xdr.TransactionResultPair{},
