...
type EventsProcessor struct {
	...
	// i.e, the ledgers were generated by stellar-core when the EMIT_CLASSIC_EVENTS flag was set to true
	readFromUnifiedEventsStream bool
}

type EventsProcessorOption func(*EventsProcessor)

func DisableContractEvents() EventsProcessorOption {
	return func(ep *EventsProcessor) {
		ep.disableContractEvents = true
	}
}
