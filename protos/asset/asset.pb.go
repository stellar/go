...
type Asset_IssuedAsset struct {
	IssuedAsset *IssuedAsset `protobuf:"bytes,2,opt,name=issuedAsset,proto3,oneof"` // Issued asset - via classic operations.
}
...
type IssuedAsset struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	AssetCode     string                 `protobuf:"bytes,1,opt,name=assetCode,proto3" json:"assetCode,omitempty"` // Asset code (e.g., USD, BTC)
...
var file_asset_asset_proto_rawDesc = []byte{
	,
	...
	0x52, 0x06, 0x69, 0x73, 0x73, 0x75, 0x65, 0x72, 0x42, 0x2a, 0x5a, 0x28, 0x67, 0x69, 0x74, 0x68,
	0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x73, 0x74, 0x65, 0x6c, 0x6c, 0x61, 0x72, 0x2f, 0x67,
	0x6f, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2f, 0x61, 0x73, 0x73, 0x65, 0x74, 0x3b, 0x61,
	0x73, 0x73, 0x65, 0x74, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_asset_asset_proto_rawDescOnce sync.Once
	file_asset_asset_proto_rawDescData = file_asset_asset_proto_rawDesc
)

func file_asset_asset_proto_rawDescGZIP() []byte {
	file_asset_asset_proto_rawDescOnce.Do(func() {
		file_asset_asset_proto_rawDescData = protoimpl.X.CompressGZIP(file_asset_asset_proto_rawDescData)
	})
	return file_asset_asset_proto_rawDescData
}

var file_asset_asset_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_asset_asset_proto_goTypes = []any{
	(*Asset)(nil),       // 0: asset.Asset
	(*IssuedAsset)(nil), // 1: asset.IssuedAsset
}
var file_asset_asset_proto_depIdxs = []int32{
	1, // 0: asset.Asset.issuedAsset:type_name -> asset.IssuedAsset
...
func file_asset_asset_proto_init() {
	...
	file_asset_asset_proto_msgTypes[0].OneofWrappers = []any{
		(*Asset_Native)(nil),
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_asset_asset_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_asset_asset_proto_rawDesc = nil
