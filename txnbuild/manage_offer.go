...
func CreateOfferOp(selling, buying Asset, amount, price string, sourceAccount ...Account) ManageSellOffer {
...
func UpdateOfferOp(selling, buying Asset, amount, price string, offerID int64, sourceAccount ...Account) ManageSellOffer {
	return ManageSellOffer{
		Selling:       selling,
		Buying:        buying,
		Amount:        amount,
...
func DeleteOfferOp(offerID int64, sourceAccount ...Account) ManageSellOffer {
