...
* [Keystore](services/keystore): An API server that is intended to be deployed per client's application. It facilitates operations on the encrypted keys of the users in the application
